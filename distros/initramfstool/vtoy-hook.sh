...
# Bundle the storage drivers and helper binaries that the runtime local-top hook
# needs to recreate the Ventoy-backed device-mapper topology during early boot.
...
for ef in dd sort head find basename xzcat zcat blkid; do
